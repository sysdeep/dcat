...
func NewVolumeHeader(bdata []byte) *VolumeHeader {

	sr := NewStreamReader(bdata)

	vh := &VolumeHeader{
		Created:     sr.ReadULong8(),
		Icon:        sr.ReadUShort2(),
		Records:     sr.ReadULong8(),
		TableLength: sr.ReadULong8(),
		HeapLength:  sr.ReadULong8(),
		NPos:        sr.ReadUInt4(),
		NSize:       sr.ReadUShort2(),
		PPos:        sr.ReadUInt4(),
		PSize:       sr.ReadUShort2(),
		DPos:        sr.ReadUInt4(),
...
func (vh *VolumeHeader) PrintInfo() {
	fmt.Println("===============================")
	fmt.Println("Created: ", vh.Created)
	fmt.Println("Icon: ", vh.Icon)
	fmt.Println("Records: ", vh.Records)
	fmt.Println("TableLength: ", vh.TableLength)
	fmt.Println("HeapLength: ", vh.HeapLength)
	fmt.Println("Name: ", vh.NPos, ":", vh.NSize)
	fmt.Println("Path: ", vh.PPos, ":", vh.PSize)
	fmt.Println("Desc: ", vh.DPos, ":", vh.DSize)
	fmt.Println("===============================")
}
